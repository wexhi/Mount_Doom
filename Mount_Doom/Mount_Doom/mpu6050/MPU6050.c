...
{	
	...
	{      
				...
				{    
					 ...
					 q2=quat[2] / q30;
					 q3=quat[3] / q30; 		//四元数
					 Pitch = asin(-2 * q1 * q3 + 2 * q0* q2)* 57.3 + 6.1; 	//计算出俯仰角
					 Roll = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3 - 1.3; // 计算出横滚角
					 Yaw = atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3 + 5.5;	 //计算出偏航角
				}
